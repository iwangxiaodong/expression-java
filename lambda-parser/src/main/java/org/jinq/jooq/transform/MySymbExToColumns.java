...
public class MySymbExToColumns extends TypedValueVisitor<Void, ColumnExpressions<?>, TypedValueVisitorException>
{
   final MetamodelUtil metamodel;
   final SymbExArgumentHandler argHandler;
   
   MySymbExToColumns(MetamodelUtil metamodel, SymbExArgumentHandler argumentHandler)
   {
