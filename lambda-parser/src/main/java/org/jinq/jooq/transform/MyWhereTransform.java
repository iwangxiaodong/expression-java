...
public class MyWhereTransform 
{
   MetamodelUtil metamodel;
   LambdaInfo where;
   public MyWhereTransform(MetamodelUtil metamodel, LambdaInfo where)
   {
...
//            SelectFromWhere<V> sfw = (SelectFromWhere<V>)query;
            MySymbExToColumns translator = new MySymbExToColumns(metamodel, 
